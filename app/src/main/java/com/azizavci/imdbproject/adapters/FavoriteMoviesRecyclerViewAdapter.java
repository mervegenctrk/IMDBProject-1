...
public class FavoriteMoviesRecyclerViewAdapter extends RecyclerView.Adapter<FavoriteMoviesRecyclerViewAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public FavoriteMoviesRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull FavoriteMoviesRecyclerViewAdapter.ViewHolder holder, int position) {
